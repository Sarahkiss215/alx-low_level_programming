...
/**
 * get_magic - gets the magic numbers of an ELF header.
 * @e_ident: A pointer to an array with the ELF magic numbers.
 * Return: Nothing.
 */
...
/**
 * get_class - gets the class of an ELF header.
...
/**
 * get_data - gets the data of an ELF header.
 * @e_ident: A pointer to an array with the ELF class.
 */
...
/**
 * get_version - gets the version of an ELF header.
...
/**
 * get_osabi - gets the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array with the ELF version.
 * Return: Nothing.
 */
...
/**
 * get_abi - gets the ABI version of an ELF header.
...
/**
 * get_type - gets the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array with the ELF type.
 */
...
/**
 * get_entry - gets the entry point of an ELF header.
